...
local  G,  home,  # the supergroup (of <H> and <U>), the home pcgs
  ...
  Print("XXX beginning of CentralizerSolvableGroup\n");
...
InstallMethod( CentralizerOp,
    ...
    function( G, g )
        Print("XXX CentralizerOp for pcgs computable group and element\n");
...
function( G, H )
local   h,P;
        Print("XXX CentralizerOp for pcgs computable groups\n");
