...
InstallMethod( GroupWithGenerators,
    ...
    function( gens )
    local G,fam,typ;
    Print("GroupWithGenerators (case 1)\n");
...
InstallMethod( GroupWithGenerators,
    ...
    function( gens, id )
    local G,fam,typ;
    Print("GroupWithGenerators (case 2)\n");
...
InstallMethod( GroupWithGenerators,
    ...
    function( empty, id )
    local G,fam,typ;
    Print("GroupWithGenerators (case 3)\n");
...
InstallGlobalFunction( Group, function( arg )
    Print("grp.gi: call of Group function\n");
