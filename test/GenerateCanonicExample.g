...
#  CreateExampleOnSetCase(eFile, Group([ ( 1, 4, 5, 9, 3)( 2, 8,10, 7, 6)(12,15,16,20,14)(13,19,21,18,17), ( 1,21, 5,12,20)( 2,16, 3, 4,17)( 6,18, 7,19,15)( 8,13, 9,14,11) ]), [ 1, 4, 6, 7, 8, 11, 12, 13, 14, 15, 17, 18, 19, 20, 21 ]);
  CreateExampleOnSetCase(eFile, Group([ ( 1, 4, 5, 9, 3)( 2, 8,10, 7, 6)(12,15,16,20,14)(13,19,21,18,17), ( 1,21, 5,12,20)( 2,16, 3, 4,17)( 6,18, 7,19,15)( 8,13, 9,14,11) ]), [ 1, 2, 3, 4, 7, 10, 13, 15, 18, 19 ]);
#  CreateExampleOnSetCase(eFile, Group([(1,2,3,4,5)]), [1]);
#  CreateExampleOnSetCase(eFile, Group([(1,2)]), [1]);
